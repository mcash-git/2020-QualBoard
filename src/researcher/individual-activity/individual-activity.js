...
export class IndividualActivity {
  ...
  configureRouter(config, router) {
    config.map([{
      ...
      route: ['responses'],
      name: 'responses',
      moduleId: './responses/activity-responses',
      nav: true,
      title: 'Responses',
      settings: {
      ...
      route: ['edit'],
      name: 'edit',
      moduleId: './edit/edit-individual-activity',
      nav: true,
      title: 'Edit Activity',
      settings: {
        iconClass: 'icon-ion-compose',
      },
    }, {
      route: ['users'],
      name: 'users',
      moduleId: './users/activity-users',
      nav: true,
      ...
      route: ['settings'],
      name: 'settings',
      moduleId: './settings/individual-activity-settings',
      nav: true,
