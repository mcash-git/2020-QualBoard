...
import { ProjectCardModel } from 'observer/models/project-card-model';
import { safeSessionStorage } from 'shared/utility/safe-session-storage';

const actionBarModulePath = 'observer/project/my-projects-action-bar';
const searchTextSessionStorageKey = 'obs-projects:projects-search';
...
export class MyProjects {
  ...
  async canActivate() {
    ...
    this.projects = this.domainState.observerProjects;
    this.applySearch();
  }
